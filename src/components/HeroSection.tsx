...
import dev2 from "../assets/person.json";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-lg lg:text-xl mb-6">
            Crafting seamless digital experiences. Bridging the gap between
            front-end brilliance and robust back-end architecture.
          </p>
          {/* <div>
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] overflow-hidden max-sm:hidden">
            {/* <img
              src={dev}
              alt="dev"
              width={300}
            ...
            /> */}
            <Lottie animationData={dev2} style={{ paddingTop: "2%" }} />
          </div>
        </motion.div>
      </div>
    </section>
